  ...
  <body>
        ...
        <nav class="navbar navbar-default navbar-static-top">
          <div class="container">
            <div class="navbar-header">
              ...
              <a class="navbar-brand" href="index.php">EKET</a>
            </div>
    ...
    <section class="showtime_page">
      <div class="container">
        <div class="row">
          <div class="col-md-12">
            <p style="font-size: 3vw; font-weight: bold;text-align: center;">THIS INDIVIDUAL DEMO PROJECT IS BUILT FOR INTERN PROJECT DEVELOPMENT AND LEARNING PURPOSE!!!
            </p>
